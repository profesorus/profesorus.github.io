...
> Note that due to me not bothering, this will remove your ability to stream
responses in Astro, as the plugin will `await` the whole body text and run
a regex on it before sending it onwards. It might also break your ability
to send non-text data (i.e. images) from SSR pages. Maybe just don't use
this for an SSR site, only use it for SSGs.
